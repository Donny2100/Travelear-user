...
import MdVolumeDown from "react-icons/lib/md/headset";
...
const sliderBaseOptions = {
  min: 0,
  step: 0.01,
  trackStyle: { backgroundColor: "#d74c39" },
  handleStyle: { backgroundColor: "#d74c39", border: "2px solid #fff" }
};

// class ShufflePlayIcon extends Component {
//   render() {
//     const normal = `${process.env.PUBLIC_URL}/images/shuffle.png`;
//     const hover = `${process.env.PUBLIC_URL}/images/shuffleon.png`;
//     return (<img src={normal}
//       onMouseOver={() => this.src = normal}
//       onMouseOut={() => this.src = hover}
//       className="imagebtn"
//     />);
//   }
// }

const ShufflePlayIcon = () => {
  const normal = `${process.env.PUBLIC_URL}/images/shuffle.png`;
  const hover = `${process.env.PUBLIC_URL}/images/shuffleon.png`;
  return <AudioIcon normal={normal} hover={hover} />
}

const RepeatIcon = () => {
  const normal = `${process.env.PUBLIC_URL}/images/loop.png`;
  const hover = `${process.env.PUBLIC_URL}/images/loopon.png`;
  return <AudioIcon normal={normal} hover={hover} />
}
...
class AudioIcon extends Component {
  constructor(props) {
    super(props);
    this.state = {src: this.props.normal};
  }
  handleMouseOver = () => {
    this.setState({src : this.props.hover});
  }
  handleMouseOut = () => {
    this.setState({src : this.props.normal});
  }
  render() {
...
export default class ReactJkMusicPlayer extends PureComponent {
                ...
                <div className="player-content" key="player-content">
                  ...
                  {loading ? (
                    ...
                    <span className="group">
                      ...
                      >
                        <AudioIcon
                          normal={`${process.env.PUBLIC_URL}/images/previous.png`}
                          hover={`${process.env.PUBLIC_URL}/images/previous.png`}
                        />
                        {/* <PrevAudioIcon /> */}
                      </span>
                      <span
                        ...
                        {...(ISMOBILE
                          ...
                          : { onClick: playing ? this._pauseAudio : this.onPlay})}
                        title={playing ? "Click to pause" : "Click to play"}
                      >
                        {playing ? (
                          <span>
                            <img src={`${process.env.PUBLIC_URL}/images/pause.png`}
                            className="playimagebtn"
                            />
                            {/* <AudioIcon
                              normal={`${process.env.PUBLIC_URL}/images/pause.png`}
                              hover={`${process.env.PUBLIC_URL}/images/shuffleon.png`}
                            /> */}
                          </span>
                        ) : (
                          <span>
                            ...
                            />
                          {/* <AudioIcon
                            normal={`${process.env.PUBLIC_URL}/images/play.png`}
                            hover={`${process.env.PUBLIC_URL}/images/loopon.png`}
                          /> */}
                          </span>
                        )}
                      </span>
                      ...
                      >
                        <AudioIcon
                          normal={`${process.env.PUBLIC_URL}/images/next.png`}
                          hover={`${process.env.PUBLIC_URL}/images/next.png`}
                        />
                        {/* <NextAudioIcon /> */}
                      </span>
                    </span>
  ...
  loadAndPlayAudio = () => {
    ...
    if (
      ...
      console.log("readysate, networkstate");
      ...
      this.setState(
        ...
        () => {
          if (remember ? !isLastPause : canPlay) {
            ...
            //   this.audio.play();
            // }, 0);
            console.log("loadandplayaudio step1");
            //this.audio.pause();
            this.audio.play().then().catch(error => {
              console.log(error);
              this._pauseAudio();
            });
          }
  ...
  bindEvents = (
    ...
    eventsNames = {
      ...
      stalled: this.handleStalled, //当浏览器尝试获取媒体数据，但数据不可用时
  ...
  componentWillReceiveProps({ audioLists }) {
    console.log("receive props", audioLists);
    console.log(this.props.audioLists);
    if (!arrayEqual(audioLists)(this.props.audioLists)) {
      if (audioLists.length > 0 && this.props.audioLists.length > 0 &&
        audioLists[0].musicSrc !== this.props.audioLists[0].musicSrc)
        this._pauseAudio();
